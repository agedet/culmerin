  ...
  return (
    <div className='bg-accen flex justify-center items-center h-auto md:h-[100v]' id='contact'>
        <div className='@container w-[100%] lg:w-[90%]'>
            <div className='flex flex-col justify-between items-center gap-40 rounded-xs lg:flex-row lg:gap-40'>
                ...
                {/* Form */}
                <div className='@container w-[95%] mx-20 flex justify-between items-center rounded-xs lg:w-[90%]'>
                    <div>
